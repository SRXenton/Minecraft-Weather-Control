...
execute as @p[scores={WeatherCycleSP=10}] run function weather-control:w_c__pages/p10 with storage weather:values temp
...
execute as @p[scores={WeatherCycleSP=20}] run function weather-control:w_c__pages/p20 with storage weather:values temp
...
execute as @p[scores={WeatherCycleSP=30}] run function weather-control:w_c__pages/p30 with storage weather:values temp
...
execute as @p[scores={WeatherCycleSP=40}] run function weather-control:w_c__pages/p40 with storage weather:values temp
